...
``delta-e`` documentation uses Sphinx_ as its main documentation compiler.
...
.. _repository: https://github.com/<USERNAME>/delta-e
.. _issue tracker: https://github.com/<USERNAME>/delta-e/issues
.. <-- end -->
